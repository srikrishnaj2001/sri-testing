...
Future<void> main() async {
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyA40XT2LSjEI_V9LCfp8YDE2qN_P9Fcduw',
      appId: '1:384321080318:web:eb44f7600efcf9452c0eaf',
    ...
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyA40XT2LSjEI_V9LCfp8YDE2qN_P9Fcduw',
      appId: '1:384321080318:android:eb44f7600efcf9452c0eaf',
      messagingSenderId: '384321080318',
      projectId: 'gem-b5006',
    ));
  }
  ...
  // Initialize messaging only on mobile platforms
  if (!kIsWeb) {
